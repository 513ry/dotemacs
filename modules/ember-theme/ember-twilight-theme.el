...
;; Copyright (C) 2025, 2026 Omer Arif and Daniel Sierpiński

;; Author: Omer Arif
;; Maintainer: Daniel Sierpiński
;; Version: 2.0
;; Package-Requires: ((emacs "24.1"))
;; Homepage: https://github.com/513ry/dotemacs/modules/ember-theme
...
(custom-theme-set-faces
 ...
 '(region ((t (:background "#65533c"))))
 
 '(mode-line ((t (:box (:line-width 1 :color "#C86028") :background "#38212B" :foreground "#EEB486" :weight bold))))
